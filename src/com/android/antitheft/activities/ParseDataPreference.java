...
public class ParseDataPreference extends EditTextPreference {

    private static final String TAG = "ParseDataPreference";
...
//        getEditText().setHint(DEFAULT_HOSTNAME);
    ...
    public ParseDataPreference(Context context) {
        this(context, null);
    }
