package com.android.antitheft.adapters;
...
public class ControlAdapter extends RecyclerView.Adapter<ControlAdapter.ViewHolder> {
    ...
    private AntiTheftCommand[] mDataSet;
     ...
     */
    public ControlAdapter(AntiTheftCommand[] dataSet) {
        mDataSet = dataSet;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View v = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.control_row_item, viewGroup, false);
